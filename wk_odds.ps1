...
$Pools = [ordered]@{
    ...
    OfficeDesk                         = "Office Desk (Generic Business)"
    OfficeDeskHome                     = "Office Desk (Home)"
    OfficeDeskHomeClassy               = "Office Desk (Home, Classy)"
    WaitingRoomDesk                    = "Waiting Room / Reception Desk"
    ClassroomDesk                      = "Classroom Desk (Elementary)"
    ClassroomSecondaryDesk             = "Classroom Desk (Secondary)"
