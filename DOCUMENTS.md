...
- **Wooden Handle and Shaft Fabrication Reference** — Wood selection and shaping for tool handles and hafts. Keys: `ToolStoreMisc`
- **Field Expedient Tool Construction Reference** — Survival school knife-based wood and bone tool making.
...
- **NEC Article Quick Reference Card** — Most-cited NEC articles. Every journeyman's pocket reference. Keys: `ElectricianTools`, `FilingCabinetGeneric`
- **Wire Gauge and Ampacity Reference** — Conductor sizing and breaker ratings by circuit type. Keys: `ElectricianTools`, `FilingCabinetGeneric`
...
- **Mortar Mix and Application Reference** — Mortar mix ratios and curing requirements by application. Keys: `ToolStoreMisc`, `FilingCabinetGeneric`
...
- **OBD-II Diagnostic Trouble Code Reference** — OBD-II diagnostic codes organized by system. Well-worn. Keys: `MechanicShelfBooks`, `CarDealerFilingCabinet`
- **Torque Specifications Quick Reference** — Fastener torques by vehicle make and system. Keys: `MechanicShelfBooks`, `CarDealerFilingCabinet`
...
- **Pattern Grading and Sizing Reference** — Garment grade rules for production pattern scaling. Keys: `FilingCabinetGeneric`
